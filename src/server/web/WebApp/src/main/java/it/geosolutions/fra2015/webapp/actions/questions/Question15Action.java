 ...
 * @author francesco
 */
public class Question15Action extends AbstractQuestionAction {

    public Question15Action() {
        super(1, 1);
    }
    ...
    public ResponseObject call(RequestObject request) {
        ...
        try {
            ...
            Logger.getLogger(Question15Action.class.getName()).log(Level.INFO, "string resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question15Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question15Action.class.getName()).log(Level.INFO, "fra2015categories resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question15Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question15Action.class.getName()).log(Level.INFO, "partb resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question15Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }

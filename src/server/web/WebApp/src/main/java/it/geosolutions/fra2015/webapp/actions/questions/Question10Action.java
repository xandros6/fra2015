 ...
 * @author francesco
 */
public class Question10Action extends AbstractQuestionAction {
    ...
    public ResponseObject call(RequestObject request) {
        ...
        try {
            ...
            Logger.getLogger(Question10Action.class.getName()).log(Level.INFO, "string resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question10Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question10Action.class.getName()).log(Level.INFO, "fra2015categories resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question10Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question10Action.class.getName()).log(Level.INFO, "parta resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question10Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }

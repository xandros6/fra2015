 ...
 * @author francesco
 */
public class Question3Action extends AbstractQuestionAction {

    public Question3Action() {
        super(1, 1);
    }
    ...
    public ResponseObject call(RequestObject request) {
        ...
        try {
            ...
            Logger.getLogger(Question3Action.class.getName()).log(Level.INFO, "string resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question3Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question3Action.class.getName()).log(Level.INFO, "fra2015categories resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question3Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question3Action.class.getName()).log(Level.INFO, "forests resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question3Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }

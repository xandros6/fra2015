 ...
 * @author francesco
 */
public class Question13Action extends AbstractQuestionAction {

    public Question13Action() {
        super(1, 1);
    }
    ...
    public ResponseObject call(RequestObject request) {
        ...
        try {
            ...
            Logger.getLogger(Question13Action.class.getName()).log(Level.INFO, "string resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question13Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question13Action.class.getName()).log(Level.INFO, "fra2015categories resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question13Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question13Action.class.getName()).log(Level.INFO, "parta resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question13Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }

 ...
 * @author francesco
 */
public class Question18Action extends AbstractQuestionAction {

    public Question18Action() {
        super(1, 1);
    }
    ...
    public ResponseObject call(RequestObject request) {
        ...
        try {
            ...
            Logger.getLogger(Question18Action.class.getName()).log(Level.INFO, "string resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question18Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question18Action.class.getName()).log(Level.INFO, "fra2015categories resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question18Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question18Action.class.getName()).log(Level.INFO, "partb resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question18Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }

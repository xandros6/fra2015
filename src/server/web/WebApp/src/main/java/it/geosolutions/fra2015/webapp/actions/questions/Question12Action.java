 ...
 * @author francesco
 */
public class Question12Action extends AbstractQuestionAction {

    public Question12Action() {
        super(1, 1);
    }
    ...
    public ResponseObject call(RequestObject request) {
        ...
        try {
            ...
            Logger.getLogger(Question12Action.class.getName()).log(Level.INFO, "string resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question12Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question12Action.class.getName()).log(Level.INFO, "fra2015categories resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question12Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }
        ...
        try {
            ...
            Logger.getLogger(Question12Action.class.getName()).log(Level.INFO, "parta resource bundle loaded");
        } catch (Exception e) {
            Logger.getLogger(Question12Action.class.getName()).log(Level.SEVERE, "invalid bundle", e);
        }

...
import it.geosolutions.fra2015.core.model.Attribute;
import it.geosolutions.fra2015.core.model.Category;
import it.geosolutions.fra2015.core.model.Resource;
import it.geosolutions.fra2015.core.model.enums.DataType;
import it.geosolutions.fra2015.services.dto.ShortAttribute;
import it.geosolutions.fra2015.services.dto.ShortResource;
import it.geosolutions.fra2015.services.dto.search.*;
import it.geosolutions.fra2015.services.rest.model.CategoryList;
import it.geosolutions.fra2015.services.rest.model.RESTCategory;
import it.geosolutions.fra2015.services.rest.model.RESTResource;
import it.geosolutions.fra2015.services.rest.model.RESTStoredData;
import it.geosolutions.fra2015.services.rest.model.ShortResourceList;
...
//            assertEquals("Not all categories have been deleted", 0, categories.getList().size());
    ...
    @Test
    public void testGetfra2015RestUrl() {
    }

    @Test
    public void testSetfra2015RestUrl() {
    }
    ...
    protected boolean pingfra2015(Fra2015Client client) {
        try {
            ...
            LOGGER.debug("Error connecting to fra2015", ex);
            //... and now for an awful example of heuristic.....
            Throwable t = ex;
            while(t!=null) {
                if(t instanceof ConnectException) {
                    LOGGER.warn("Testing fra2015 is offline");
                    return false;
                }
                t = t.getCause();
            }

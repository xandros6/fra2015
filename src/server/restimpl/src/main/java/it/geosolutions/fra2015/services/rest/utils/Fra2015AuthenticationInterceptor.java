...
/**
 *
 * Class fra2015AuthenticationInterceptor. Starting point was
 * JAASLoginInterceptor.
 *
 * @author ETj (etj at geo-solutions.it)
 * @author Tobia di Pisa (tobia.dipisa at geo-solutions.it)
 */
public class Fra2015AuthenticationInterceptor extends AbstractPhaseInterceptor<Message> {

    private static final Logger LOGGER = Logger.getLogger(Fra2015AuthenticationInterceptor.class);
    ...
    public Fra2015AuthenticationInterceptor() {
...
//            }
        ...
        Fra2015SecurityContext securityContext = new Fra2015SecurityContext();
        Fra2015Principal principal = user != null
                ? new Fra2015Principal(user) : Fra2015Principal.createGuest();

...
$(function() {
    ...
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q01')}">
       batchExportQuestionsDuallistbox.append('<option value="1" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref11'></spring:message></option>');
    </c:if>   
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q02')}">
       batchExportQuestionsDuallistbox.append('<option value="2" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref89'></spring:message></option>');
    </c:if>   
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q03')}">
       batchExportQuestionsDuallistbox.append('<option value="3" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref130'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q04')}">
       batchExportQuestionsDuallistbox.append('<option value="4" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref215'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q05')}">
       batchExportQuestionsDuallistbox.append('<option value="5" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref259'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q06')}">
       batchExportQuestionsDuallistbox.append('<option value="6" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref310'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q07')}">
       batchExportQuestionsDuallistbox.append('<option value="7" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref319'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q08')}">
       batchExportQuestionsDuallistbox.append('<option value="8" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref334'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q09')}">
       batchExportQuestionsDuallistbox.append('<option value="9" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref371'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q10')}">
       batchExportQuestionsDuallistbox.append('<option value="10" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref377'></spring:message></option>');
    </c:if>
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q11')}">
       batchExportQuestionsDuallistbox.append('<option value="11" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref392'></spring:message></option>');
    </c:if>  
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q12')}">
       batchExportQuestionsDuallistbox.append('<option value="12" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref397'></spring:message></option>');
    </c:if>  
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q13')}">
       batchExportQuestionsDuallistbox.append('<option value="13" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref407'></spring:message></option>');
    </c:if>  
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q14')}">
       batchExportQuestionsDuallistbox.append('<option value="14" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref435'></spring:message></option>');
    </c:if>  
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q15')}">
       batchExportQuestionsDuallistbox.append('<option value="15" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref457'></spring:message></option>');
    </c:if>  
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q16')}">
       batchExportQuestionsDuallistbox.append('<option value="16" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref467'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q17')}">
       batchExportQuestionsDuallistbox.append('<option value="17" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref487'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q18')}">
       batchExportQuestionsDuallistbox.append('<option value="18" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref495'></spring:message></option>');
    </c:if> 
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q19')}">
       batchExportQuestionsDuallistbox.append('<option value="19" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref536'></spring:message></option>');
    </c:if>
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q20')}">
       batchExportQuestionsDuallistbox.append('<option value="20" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref545'></spring:message></option>');
    </c:if>
    <c:if test="${sessionUser.role!='reviewer' || fn:contains(allowedQuestions, 'q21')}">
       batchExportQuestionsDuallistbox.append('<option value="21" selected="selected"><spring:message htmlEscape='true' javaScriptEscape='true' code='ref554'></spring:message></option>');
    </c:if>

<%@ include file="../../common/includes/taglibs.jsp"%>
	...
	<c:set var ="qpath" value="${surveypath}/${q}" />
			...
			<tr>
				<td rowspan="17"><a href="${qpath}#1b">1b</a></td>
			</tr>
			<tr>
			    <td colspan="7"><strong><spring:message code="ref66"></spring:message></strong></td>
			</tr>
			<tr class="summaryRow">
				...
				<td class="numeric">${_fraVariable_1b_2_4_}</td>
			...
			<tr class="summaryRow">
				...
				<td class="numeric">${_fraVariable_1b_3_4_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				...
				<td class="numeric">${_fraVariable_1b_4_4_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				...
				<td class="numeric">${_fraVariable_1b_5_4_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				...
				<td class="numeric">${_fraVariable_1b_6_4_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				...
				<td class="numeric">${_fraVariable_1b_7_4_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				...
				<td class="numeric">${_fraVariable_1b_8_4_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr>
				<td colspan="7"><strong><spring:message code="ref67"></spring:message></strong></td>
			</tr>
			<tr class="summaryRow">
				<td>1.6 <spring:message code="ref68"></spring:message></td>
				<td>1000 ha</td>
				...
				<td class="numeric">${_fraVariable_1b_2_9_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				<td>1.6.1 <spring:message code="ref69"></spring:message></td>
				...
				<td class="numeric">${_fraVariable_1b_3_9_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				<td>1.6.2 <spring:message code="ref70"></spring:message></td>
				...
				<td class="numeric">${_fraVariable_1b_4_9_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				<td>1.7 <spring:message code="ref31"></spring:message></td>
				...
				<td class="numeric">${_fraVariable_1b_5_9_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				<td>1.7.1 <spring:message code="ref71"></spring:message></td>
				...
				<td class="numeric">${_fraVariable_1b_6_9_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				<td>1.8 <spring:message code="ref27"></spring:message></td>
				...
				<td class="numeric">${_fraVariable_1b_7_9_}</td>
				<td class="notpresent"></td>
			</tr>
			<tr class="summaryRow">
				<td>1.8.1 <spring:message code="ref72"></spring:message></td>
				...
				<td class="numeric">${_fraVariable_1b_8_9_}</td>
				<td class="notpresent"></td>
			</tr>
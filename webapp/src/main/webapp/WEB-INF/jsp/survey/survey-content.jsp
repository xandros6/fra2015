...
<div class="span8" id="survey-content"> <!-- duplicated id in the page investigate -->
<section>
...
</p><div></div><div class="entry"><table class="editable extensible table table-bordered table-hover table-condensed table-striped">
<tbody>
<tr>
<td rownumber="0" columnnumber="0">
Name (FAMILY NAME, first name)
</td>
<td rownumber="0" columnnumber="1">
Istitution/address
</td>
<td rownumber="0" columnnumber="2">
Email
</td>
<td rownumber="0" columnnumber="3">
Tables
</td>
<td class="action-column" width="80px"></td></tr>
<tr>
<td rownumber="1" columnnumber="0" class="entry-item editable text" style="background-color: rgb(242, 245, 169); " entry-id="0"><input class="entry-item-value" type="hidden"><div id="cell-content" contenteditable="true"> </div></td>
...
</p><div></div><div class="entry"><textarea class="texteditor" entry-item-id="0" cols="160" rows="10" rownumber="0" columnnumber="0" entry-id="1"> </textarea>
<div class="control pull-right">
</div><br><br></div>
</section>
<!-- extra div close investigate where the division is wrong -->

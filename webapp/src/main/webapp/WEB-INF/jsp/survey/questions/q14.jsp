...
<fra:yesno mod=" editable " name="_fraVariable_14b_5_1_"  rownumber="5" columnnumber="1" style="background-color: rgb(242, 245, 169); " entryId="14b"></fra:yesno>
	...
	<c:if test="${fn:contains(notEmptyEntry,'_908_') || param.hideEmpty != 'true'}">
		<section>
			<h3>
			...
			<div>
				<div></div>
				<div class="entry">
					<fra:richtextentry name="_fraVariable_908_"></fra:richtextentry>
				</div>
				<div class="control clearfix"></div>
				<fra:feedback feedbackName="_feedback_908_"/>
				<br/>
				<br/>
			</div>
		</section>

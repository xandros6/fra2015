...
<section>
	...
	<c:if test="${fn:contains(notEmptyEntry,'_905_') || param.hideEmpty != 'true'}">
		<section>
			<h3>
			...
			<div>
				<div></div>
				<div class="entry">
					<fra:richtextentry name="_fraVariable_905_"></fra:richtextentry>
				</div>
				<div class="control clearfix"></div>
				<fra:feedback feedbackName="_feedback_905_"/>
				<br/>
				<br/>
			</div>
		</section>

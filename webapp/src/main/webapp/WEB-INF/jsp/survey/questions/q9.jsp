...
<section>
	...
	<c:if test="${fn:contains(notEmptyEntry,'_903_') || param.hideEmpty != 'true'}">
		<section>
			<h3>
			...
			<div>
				<div></div>
				<div class="entry">
					<fra:richtextentry name="_fraVariable_903_"></fra:richtextentry>
				</div>
				<div class="control clearfix"></div>
				<fra:feedback feedbackName="_feedback_903_"/>
				<br/>
				<br/>
			</div>
		</section>

...
<section>
	...
	<c:if test="${fn:contains(notEmptyEntry,'_913_') || param.hideEmpty != 'true'}">
		<section>
			<h3>
			...
			<div>
				<div></div>
				<div class="entry">
					<fra:richtextentry name="_fraVariable_913_"></fra:richtextentry>
				</div>
				<div class="control clearfix"></div>
				<fra:feedback feedbackName="_feedback_913_"/>
				<br/>
				<br/>
			</div>
		</section>

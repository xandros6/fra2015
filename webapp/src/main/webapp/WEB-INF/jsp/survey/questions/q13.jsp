...
<fra:yesno mod=" editable " name="_fraVariable_13b_7_1_"  rownumber="7" columnnumber="1" style="background-color: rgb(242, 245, 169); " entryId="13b"></fra:yesno>
	...
	<section>
		...
		<c:if test="${fn:contains(notEmptyEntry,'_907_') || param.hideEmpty != 'true'}">
		<section>
			<h3>
			...
			<div>
				<div></div>
				<div class="entry">
					<fra:richtextentry name="_fraVariable_907_"></fra:richtextentry>
				</div>
				<div class="control clearfix"></div>
				<fra:feedback feedbackName="_feedback_907_"/>
				<br/>
				<br/>
			</div>
		</section>

						...
						<tbody>
							...
							<tr>
								...
								<td class="entry-item editable text" rownumber="2"
									columnnumber="1" style="background-color: rgb(242, 245, 169);"
									entry-id="120"><input class="entry-item-value"
									type="hidden" value="${_variable_120[2][1]}"
									name="_variable_120[2][1]">
								<div id="cell-content">${_variable_120[2][1]}</div></td>
								<td class="entry-item editable text" rownumber="2"
									columnnumber="2" style="background-color: rgb(242, 245, 169);"
									entry-id="120"><input class="entry-item-value"
									type="hidden" value="${_variable_120[2][2]}"
									name="_variable_120[2][2]">
								<div id="cell-content">${_variable_120[2][2]}</div></td>
								<td class="entry-item editable text" rownumber="2"
									columnnumber="3" style="background-color: rgb(242, 245, 169);"
									entry-id="120"><input class="entry-item-value"
									type="hidden" value="${_variable_120[2][3]}"
									name="_variable_120[2][3]">
								<div id="cell-content">${_variable_120[2][3]}</div></td>
								<td class="entry-item editable text" rownumber="2"
									columnnumber="4" style="background-color: rgb(242, 245, 169);"
									entry-id="120"><input class="entry-item-value"
									type="hidden" value="${_variable_120[2][4]}"
							...
							<tr>
								...
								<td class="entry-item editable text" rownumber="3"
									columnnumber="1" style="background-color: rgb(242, 245, 169);"
									entry-id="120"><input class="entry-item-value"
									type="hidden" value="${_variable_120[3][1]}"
									name="_variable_120[3][1]">
								<div id="cell-content">${_variable_120[3][1]}</div></td>
								<td class="entry-item editable text" rownumber="3"
									columnnumber="2" style="background-color: rgb(242, 245, 169);"
									entry-id="120"><input class="entry-item-value"
									type="hidden" value="${_variable_120[3][2]}"
									name="_variable_120[3][2]">
								<div id="cell-content">${_variable_120[3][2]}</div></td>
								<td class="entry-item editable text" rownumber="3"
									columnnumber="3" style="background-color: rgb(242, 245, 169);"
									entry-id="120"><input class="entry-item-value"
									type="hidden" value="${_variable_120[3][3]}"
									name="_variable_120[3][3]">
								<div id="cell-content">${_variable_120[3][3]}</div></td>
								<td class="entry-item editable text" rownumber="3"
									columnnumber="4" style="background-color: rgb(242, 245, 169);"
									entry-id="120"><input class="entry-item-value"
									type="hidden" value="${_variable_120[3][4]}"
						...
						<tbody>
							...
							<tr>
								<td class="entry-item editable text" rownumber="1"
									...
									entry-id="121"><input class="entry-item-value"
									type="hidden" value="${_variable_121[1][0]}"
									name="_variable_121[1][0]">
								<div id="cell-content">${_variable_121[1][0]}</div></td>
								<td class="entry-item editable text" rownumber="1"
									columnnumber="1" style="background-color: rgb(242, 245, 169);"
									entry-id="121"><input class="entry-item-value"
									type="hidden" value="${_variable_121[1][1]}"
							...
							<tr>
								<td class="entry-item editable text" rownumber="2"
									columnnumber="0" style="background-color: rgb(242, 245, 169);"
									entry-id="121"><input class="entry-item-value"
									type="hidden" value="${_variable_121[2][0]}"
									name="_variable_121[2][0]">
								<div id="cell-content">${_variable_121[2][0]}</div></td>
								<td class="entry-item editable text" rownumber="2"
									columnnumber="1" style="background-color: rgb(242, 245, 169);"
									entry-id="121"><input class="entry-item-value"
									type="hidden" value="${_variable_121[2][1]}"
							...
							<tr>
								<td class="entry-item editable text" rownumber="3"
									columnnumber="0" style="background-color: rgb(242, 245, 169);"
									entry-id="121"><input class="entry-item-value"
									type="hidden" value="${_variable_121[3][0]}"
									name="_variable_121[3][0]">
								<div id="cell-content">${_variable_121[3][0]}</div></td>
								<td class="entry-item editable text" rownumber="3"
									columnnumber="1" style="background-color: rgb(242, 245, 169);"
									entry-id="121"><input class="entry-item-value"
									type="hidden" value="${_variable_121[3][1]}"
					...
					<tbody>
						...
						<tr rowname="13.2" unit="%,year,checkbox" class="summary-na">
							...
							<td class="entry-item editable text" rownumber="3"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[3][1]}"
								name="_variable_13a[3][1]">
							<div id="cell-content">${_variable_13a[3][1]}</div></td>
							<td class="entry-item editable text" rownumber="3"
								columnnumber="2" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[3][2]}"
								name="_variable_13a[3][2]">
							<div id="cell-content">${_variable_13a[3][2]}</div></td>
							<td class="entry-item editable text" rownumber="3"
								columnnumber="3" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[3][3]}"
								name="_variable_13a[3][3]">
							<div id="cell-content">${_variable_13a[3][3]}</div></td>
							<td class="entry-item editable text" rownumber="3"
								columnnumber="4" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[3][4]}"
								name="_variable_13a[3][4]">
							<div id="cell-content">${_variable_13a[3][4]}</div></td>
							<td class="entry-item editable text" rownumber="3"
								columnnumber="5" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[3][5]}"
								name="_variable_13a[3][5]">
							<div id="cell-content">${_variable_13a[3][5]}</div></td>
							<td class="entry-item editable text" rownumber="3"
								columnnumber="6" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[3][6]}"
								name="_variable_13a[3][6]">
							<div id="cell-content">${_variable_13a[3][6]}</div></td>
							<td class="entry-item editable text" rownumber="3"
								columnnumber="7" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[3][7]}"
								name="_variable_13a[3][7]">
							<div id="cell-content">${_variable_13a[3][7]}</div></td>
							<td class="entry-item editable text" rownumber="3"
								columnnumber="8" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[3][8]}"
								name="_variable_13a[3][8]">
						...
						<tr rowname="13.3" unit="%,year,checkbox" class="summary-na">
							...
							<td class="entry-item editable text" rownumber="4"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[4][1]}"
								name="_variable_13a[4][1]">
							<div id="cell-content">${_variable_13a[4][1]}</div></td>
							<td class="entry-item editable text" rownumber="4"
								columnnumber="2" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[4][2]}"
								name="_variable_13a[4][2]">
							<div id="cell-content">${_variable_13a[4][2]}</div></td>
							<td class="entry-item editable text" rownumber="4"
								columnnumber="3" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[4][3]}"
								name="_variable_13a[4][3]">
							<div id="cell-content">${_variable_13a[4][3]}</div></td>
							<td class="entry-item editable text" rownumber="4"
								columnnumber="4" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[4][4]}"
								name="_variable_13a[4][4]">
						...
						<tr rowname="13.4" unit="%,year,checkbox" class="summary-na">
							...
							<td class="entry-item editable text" rownumber="5"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[5][1]}"
								name="_variable_13a[5][1]">
							<div id="cell-content">${_variable_13a[5][1]}</div></td>
							<td class="entry-item editable text" rownumber="5"
								columnnumber="2" style="background-color: rgb(242, 245, 169);"
								entry-id="13a"><input class="entry-item-value"
								type="hidden" value="${_variable_13a[5][2]}"
								name="_variable_13a[5][2]">
					...
					<tbody>
						...
						<tr rowname="13.5.1" unit="%,year,checkbox">
							...
							<td class="entry-item editable boolean" rownumber="1"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="13b"><input class="entry-item-value"
								type="hidden" value="${_variable_13b[1][1]}"
						...
						<tr rowname="13.5.2" unit="%,year,checkbox">
							...
							<td class="entry-item editable boolean" rownumber="3"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="13b"><input class="entry-item-value"
								type="hidden" value="${_variable_13b[3][1]}"
						...
						<tr rowname="13.5.3" unit="%,year,checkbox">
							...
							<td class="entry-item editable boolean" rownumber="5"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="13b"><input class="entry-item-value"
								type="hidden" value="${_variable_13b[5][1]}"
						...
						<tr rowname="13.5.4" unit="%,year,checkbox">
							...
							<td class="entry-item editable boolean" rownumber="7"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="13b"><input class="entry-item-value"
								type="hidden" value="${_variable_13b[7][1]}"
					...
					<tbody>
						...
						<tr>
							<td rownumber="1" columnnumber="0"
								...
								style="background-color: rgb(242, 245, 169);" entry-id="122"><input
								class="entry-item-value" type="hidden"
								value="${_variable_122[1][0]}" name="_variable_122[1][0]">
				...
				<table
					...
					<tbody>
						...
						<tr>
							<td class="entry-item editable text" rownumber="1"
								columnnumber="0" style="background-color: rgb(242, 245, 169);"
								entry-id="123"><input class="entry-item-value"
								type="hidden" value="${_variable_123[1][0]}"
								name="_variable_123[1][0]">
							<div id="cell-content">${_variable_123[1][0]}</div></td>
							<td class="entry-item editable text" rownumber="1"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="123"><input class="entry-item-value"
								type="hidden" value="${_variable_123[1][1]}"
								name="_variable_123[1][1]">
						...
						<tr>
							<td class="entry-item editable text" rownumber="2"
								columnnumber="0" style="background-color: rgb(242, 245, 169);"
								entry-id="123"><input class="entry-item-value"
								type="hidden" value="${_variable_123[2][0]}"
								name="_variable_123[2][0]">
							<div id="cell-content">${_variable_123[2][0]}</div></td>
							<td class="entry-item editable text" rownumber="2"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="123"><input class="entry-item-value"
								type="hidden" value="${_variable_123[2][1]}"
								name="_variable_123[2][1]">
						...
						<tr>
							<td class="entry-item editable text" rownumber="3"
								columnnumber="0" style="background-color: rgb(242, 245, 169);"
								entry-id="123"><input class="entry-item-value"
								type="hidden" value="${_variable_123[3][0]}"
								name="_variable_123[3][0]">
							<div id="cell-content">${_variable_123[3][0]}</div></td>
							<td class="entry-item editable text" rownumber="3"
								columnnumber="1" style="background-color: rgb(242, 245, 169);"
								entry-id="123"><input class="entry-item-value"
								type="hidden" value="${_variable_123[3][1]}"
								name="_variable_123[3][1]">

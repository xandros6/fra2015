...
<ul class="nav">
	<li class="${context=='surveylist' ? 'active' : '' }"><a
		href="${context!='surveylist' ? 'surveylist/0':'#'}" class="tab" data-i18n="toolbar_surveys"><spring:message
				code="toolbar.surveys" /></a></li>
	<li class="${context=='activitylog' ? 'active' : '' }"><a
		href="${context!='surveylist' ? '':'../'}revieweractivitylog" class="tab"> <spring:message

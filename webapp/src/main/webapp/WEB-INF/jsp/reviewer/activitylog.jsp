...
<div>
  <div class="container">
    <div class="row">
      <div class="span12">
        <form:form id="filterActivityLogForm" commandName="logFilter"  method="post" action="${pageContext.request.contextPath}/revieweractivitylog/filter">
        ...
        <div class="pagination pagination-centered">
          <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/revieweractivitylog/${pagination.firstPage}">First</a></li>
            </c:if>
            ...
            <li><a href="${pageContext.request.contextPath}/revieweractivitylog/${pagination.prev1}">Prev</a></li>
            </c:if>
            ...
            <li><a href="${pageContext.request.contextPath}/revieweractivitylog/${pagination.prev2}">${pagination.prev2+1}</a></li>
            </c:if>
            ...
            <c:if test="${not empty pagination.prev1}">
            <li><a href="${pageContext.request.contextPath}/revieweractivitylog/${pagination.prev1}">${pagination.prev1+1}</a></li>
            </c:if>
            <c:if test="${empty pagination.prev1}">
              <li class="disabled"><a href="#"> - </a></li>
            </c:if>
            ...
            <c:if test="${not empty pagination.next1}">
              <li><a href="${pageContext.request.contextPath}/revieweractivitylog/${pagination.next1}">${pagination.next1+1}</a></li>
            </c:if>
            ...
            <c:if test="${not empty pagination.next2}">
              <li><a href="${pageContext.request.contextPath}/revieweractivitylog/${pagination.next2}">${pagination.next2+1}</a></li>
            </c:if>
            ...
            <c:if test="${not empty pagination.next1}">
              <li><a href="${pageContext.request.contextPath}/revieweractivitylog/${pagination.next1}">Next</a></li>
            </c:if>
            <c:if test="${empty pagination.next1}">
            ...
            <c:if test="${not empty pagination.lastPage}">
              <li><a href="${pageContext.request.contextPath}/revieweractivitylog/${pagination.lastPage}">Last</a></li>
            </c:if>
